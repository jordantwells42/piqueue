  ...
  return (
    <div
      className={
        ...
        ' w-full  aspect-[0.7143] m-2 md:w-full md:min-h-48 md:aspect-auto rounded-xl border-2' +
        ' md:border-4 border-slate-900 flex flex-col justify-content items-center text-slate-900 font-mono'
      }
    >
      {!task ? (
